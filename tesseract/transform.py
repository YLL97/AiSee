...
def order_points(pts):
	...
	# The four points are assigned in the bottom right quadrant of a horizontally flipped Cartesian plane!!!
...
def four_point_transform(image, pts):
	...
	M = cv2.getPerspectiveTransform(rect, dst)  # Create a 3x3 transformation matrix from given 2 sets of 4 pts input
	warped = cv2.warpPerspective(image, M, (maxWidth, maxHeight))  # Perform perspective transform based on givem 3x3 Transformation Matrix
	# return the warped image
	return warped

## Test
# Img = cv2.imread('D:/Users/Leong/Pictures/strawb.jpg')
# warp = four_point_transform(Img, np.array([[25, 500], [450, 400], [400, 30], [40, 10]]))
# cv2.imshow('warped shit', warp)
# cv2.waitKey(0)